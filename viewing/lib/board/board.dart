...
class BoardPage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar:AppBar(
        title:const Text("Viewing 게시판",style:TextStyle(color: Colors.black,letterSpacing: 2.0,fontWeight: FontWeight.w700),),
...
class BoardModel {
  const BoardModel(this.name, this.title, this.content, this.heartnum, this.reviewnum, this.date);
  final String name;
  final String title;
